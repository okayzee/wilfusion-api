...
module.exports = (app) => {
    ...
    app.get('/api/prescription/verify', verifyToken, PrescriptionController.verifyPrescription);
    ...
    app.post('/api/prescription/reminder', verifyToken, PrescriptionController.prescriptionReminder);
